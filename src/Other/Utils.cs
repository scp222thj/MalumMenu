...
public static class Utils
{
    ...
    // Found here: https://github.com/0xDrMoe/TownOfHost-Enhanced/blob/main/Modules/Utils.cs
...
// Creates the player pick menu used in several cheats
        ...
        if (IsActive)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                shapeshifterPanel.SetPlayer(i, playerData, (Il2CppSystem.Action)(() =>
                {
                    ...
                    customAction.Invoke(); // Custom action set is called
                    __instance.Close();
                }));
