        ...
        if (CheatSettings.teleportPlayer){
            ...
            if (!isActive){
                ...
                if (Utils_PlayerPickMenu.playerpickMenu != null){
                    ...
                    CheatSettings.spectate = CheatSettings.callMeeting = CheatSettings.massShapeshift = CheatSettings.shapeshiftCheat = CheatSettings.kickPlayer = CheatSettings.murderPlayer = false;
                }
