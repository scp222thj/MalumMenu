        ...
        if (CheatSettings.teleportPlayer){
            ...
            if (!isActive){
                ...
                if (Utils_PlayerPickMenu.playerpickMenu != null){
                    ...
                    CheatSettings.spectate = CheatSettings.callMeeting = CheatSettings.chatMimic = CheatSettings.copyAllOutfits = CheatSettings.saveSpoofData = CheatSettings.copyOutfit = CheatSettings.kickPlayer = CheatSettings.murderPlayer = false;
                }
