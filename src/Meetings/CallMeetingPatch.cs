        ...
        if (CheatSettings.callMeeting){
            ...
            if (!isActive){
                ...
                if (Utils_PlayerPickMenu.playerpickMenu != null){
                    ...
                    CheatSettings.spectate = CheatSettings.murderPlayer = CheatSettings.copyAllOutfits = CheatSettings.saveSpoofData = CheatSettings.chatMimic = CheatSettings.copyOutfit = CheatSettings.teleportPlayer = CheatSettings.kickPlayer = false;
                }
