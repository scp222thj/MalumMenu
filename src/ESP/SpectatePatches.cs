        ...
        if (CheatSettings.spectate){
            ...
            if (!isActive){
                ...
                if (Utils_PlayerPickMenu.playerpickMenu != null){
                    ...
                    CheatSettings.teleportPlayer = CheatSettings.callMeeting = CheatSettings.massShapeshift = CheatSettings.shapeshiftCheat = CheatSettings.kickPlayer = CheatSettings.murderPlayer = false;
                }
