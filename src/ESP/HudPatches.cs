...
public static class ESP_HudManagerPostfix
{
    ...
    public static void Postfix(HudManager __instance){
        ...
        if (Utils_PlayerPickMenu.playerpickMenu != null && !CheatSettings.massShapeshift && !CheatSettings.massMurder && !CheatSettings.teleportPlayer && !CheatSettings.shapeshiftCheat  && !CheatSettings.murderPlayer && !CheatSettings.kickPlayer && !CheatSettings.spectate){
