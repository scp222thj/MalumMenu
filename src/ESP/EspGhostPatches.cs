...
public static class ESP_ProtectPlayerPrefix
{
    ...
    public static bool Prefix(PlayerControl target, int colorId, PlayerControl __instance){
		...
		target.TurnOnProtection(CheatSettings.seeGhosts || PlayerControl.LocalPlayer.Data.IsDead, colorId, (int)__instance.Data.PlayerId); //Render protection animation if LocalPlayer dead or CheatSettings.seeGhosts
