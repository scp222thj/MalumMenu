        ...
        if (CheatSettings.kickPlayer){
            ...
            if (!isActive){
                ...
                if (Utils_PlayerPickMenu.playerpickMenu != null){
                    ...
                    CheatSettings.spectate = CheatSettings.callMeeting = CheatSettings.massShapeshift = CheatSettings.shapeshiftCheat = CheatSettings.teleportPlayer = CheatSettings.murderPlayer = false;
                }
