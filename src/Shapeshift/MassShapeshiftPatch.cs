        ...
        if (CheatSettings.massShapeshift){
            ...
            if (!isActive){
                ...
                if (Utils_PlayerPickMenu.playerpickMenu != null){
                    ...
                    CheatSettings.spectate = CheatSettings.callMeeting = CheatSettings.murderPlayer = CheatSettings.shapeshiftCheat = CheatSettings.teleportPlayer = CheatSettings.kickPlayer = false;
                }
            ...
            if (Utils_PlayerPickMenu.playerpickMenu == null){
                CheatSettings.massShapeshift = false;
            }
