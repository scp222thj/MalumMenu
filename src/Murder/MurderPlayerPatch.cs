        ...
        if (CheatSettings.murderPlayer){
            ...
            if (!isActive){
                ...
                if (Utils_PlayerPickMenu.playerpickMenu != null){
                    ...
                    CheatSettings.spectate = CheatSettings.chatMimic = CheatSettings.callMeeting = CheatSettings.copyAllOutfits = CheatSettings.saveSpoofData = CheatSettings.copyOutfit = CheatSettings.teleportPlayer = CheatSettings.kickPlayer = false;
                }
