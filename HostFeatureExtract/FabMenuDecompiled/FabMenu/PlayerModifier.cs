...
public static class PlayerModifier
{
	...
	private static int newColorId = 0;
	...
	{
		if ((Object)(object)selectedPlayer == (Object)null || string.IsNullOrEmpty(newPlayerName))
		{
			return;
		}
		...
		if ((Object)(object)selectedPlayer.Object != (Object)null)
		{
			try
			{
		...
		try
		{
			if (Utils.isLocalGame || Utils.isFreePlay)
			{
				...
				string text2 = $"[FABMOD]|NAME|{selectedPlayer.PlayerId}|{value}";
	...
	public static void ApplyColorChange()
	{
		...
		int num = Mathf.Clamp(newColorId, 0, ((Il2CppArrayBase<Color32>)(object)Palette.PlayerColors).Length - 1);
		if ((Object)(object)selectedPlayer.Object != (Object)null)
		{
			try
			{
				selectedPlayer.Object.SetColor(num);
			}
			catch
			{
			}
		...
		try
		{
			if (Utils.isLocalGame || Utils.isFreePlay)
			{
				string text = $"[FABMOD]|COLOR|{selectedPlayer.PlayerId}|{num}";
	...
	{
		if (Utils.isHost && !((Object)(object)playerData == (Object)null) && !string.IsNullOrEmpty(newName))
		{
	...
	{
		if (Utils.isHost && !((Object)(object)playerData == (Object)null))
		{
